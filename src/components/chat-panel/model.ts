...
export const STATUS_LABELS: Record<string, LangText> = {
  idle: { ko: "대기중", en: "Idle", ja: "待機中", zh: "待机中", pt: "Disponível" },
  working: { ko: "작업중", en: "Working", ja: "作業中", zh: "工作中", pt: "Trabalhando" },
  break: { ko: "휴식", en: "Break", ja: "休憩中", zh: "休息中", pt: "Pausa" },
  offline: { ko: "오프라인", en: "Offline", ja: "オフライン", zh: "离线", pt: "Offline" },
};
