...
const LOCALE_TEXT = {
  ...
  statsEmployees: { ko: "직원", en: "Staff", ja: "スタッフ", zh: "员工", pt: "Equipe" },
  statsWorking: { ko: "작업중", en: "Working", ja: "作業中", zh: "处理中", pt: "Trabalhando" },
  statsProgress: { ko: "진행", en: "In Progress", ja: "進行", zh: "进行中", pt: "Em Progresso" },
  statsDone: { ko: "완료", en: "Done", ja: "完了", zh: "已完成", pt: "Concluído" },
  hint: {
    ...
    pt: "WASD/Setas/Pad Virtual: Mover CEO  |  Enter: Interagir",
  },
  mobileEnter: {
    ko: "Enter",
    en: "Enter",
  ...
  noAssignedAgent: {
    ...
    ja: "担当スタッフなし",
    zh: "暂无分配员工",
    pt: "Nenhum funcionário atribuído",
  },
  breakRoom: {
    ko: "☕ 휴게실",
    en: "☕ Break Room",
  ...
  role: {
    team_leader: { ko: "팀장", en: "Lead", ja: "リーダー", zh: "组长", pt: "Líder" },
    senior: { ko: "시니어", en: "Senior", ja: "シニア", zh: "资深", pt: "Sênior" },
    junior: { ko: "주니어", en: "Junior", ja: "ジュニア", zh: "初级", pt: "Júnior" },
    intern: { ko: "인턴", en: "Intern", ja: "インターン", zh: "实习", pt: "Estagiário" },
    part_time: { ko: "알바", en: "Part-time", ja: "アルバイト", zh: "兼职", pt: "Meio período" },
  },
  partTime: {
    ko: "알바",
    en: "Part-time",
  ...
  kickoffLines: {
    ...
    pt: [
      "Verificando impacto entre equipes",
      "Compartilhando riscos/dependências",
      "Alinhando cronograma/prioridades",
      "Definindo limites de responsabilidade",
    ],
  },
  reviewLines: {
    ...
    pt: [
      ...
      "Revisando rascunho final de aprovação",
      "Compartilhando ideias de revisão",
      "Revisão cruzada de entregas",
    ],
  },
  meetingTableHint: {
    ...
    zh: "📝 会议进行中：点击桌子查看纪要",
    pt: "📝 Reunião ao vivo: clique na mesa para ver a ata",
  },
  cliUsageTitle: {
    ko: "CLI 사용량",
    en: "CLI Usage",
...
const BREAK_CHAT_MESSAGES: Record<SupportedLocale, string[]> = {
  ...
  pt: [
    ...
    "Esse projeto tá osso haha",
    "Café com leite é vida!",
    "Dia lindo hoje~",
    "Não quero fazer hora extra...",
    "Quero comer algo gostoso",
